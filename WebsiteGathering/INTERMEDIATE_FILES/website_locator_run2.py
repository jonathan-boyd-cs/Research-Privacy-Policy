...
with sync_playwright() as playwright:
    ...
    for industry in industries.all():
        ...
        if indust == "All categories": continue
        
        industry_list.append(indust)

    with open("website-scrape-run4.txt",'w') as f:
        ...
        for industry in industry_list:
            ...
            for link in link_segment.all():
                ...
                if url in website_database[industry.upper()]:
                    site_data = website_database[industry.upper()][url]
                    for key in site_data.keys():
                        if site_data[key] == None:
                            populated = False
                else:
                    populated = False
